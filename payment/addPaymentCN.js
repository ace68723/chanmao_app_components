...
export default class addPaymentCN extends Component {
    constructor(){
      super();
    }
        ...
        <View style={styles.container}>
            <View style={styles.optContainer}>
                <View style={styles.option}>
                  ...
                  <Text style={styles.optionFont}>信用卡</Text>
                ...
                <View style={styles.option}>
                  ...
                  <Text style={styles.optionFont}>储蓄卡</Text>
                  <Icon name="chevron-right" size={20} style={styles.arrow}/>
                </View>
                <View style={styles.option}>
                  <View style={styles.icon}>
                  ...
                  <Text style={styles.optionFont}>现金</Text>
                  <Icon name="chevron-right" size={20} style={styles.arrow}/>
                </View>
            </View>
...
AppRegistry.registerComponent('addPaymentCN', () => addPaymentCN);
