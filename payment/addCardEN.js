...
export default class addCardEN extends Component {
    constructor(){
      super();
      this.state = {
          isOpen:true,
    ...
    //                 <Text style={styles.buttonFont} allowFontScaling={false}>Close</Text>
    //             </TouchableOpacity>
    //         </View>
    //     </Modal>
    //   )
        ...
        <View style={styles.container}>
          ...
          <View style={styles.infoContainer}>
            <View style={styles.cardNo}>
              <View style={styles.title}><Text style={{fontSize:16,color:'#737373'}} allowFontScaling={false}>Card Number</Text></View>
            ...
            <View style={styles.cardDetails}>
                <View style={styles.otherInfo}>
                  <View style={styles.title}><Text style={{fontSize:16,color:'#737373'}} allowFontScaling={false}>EXP. Date</Text></View>
                  <View style={styles.input}>
          ...
          <View style={{flex:0.7}}>
            <TouchableOpacity style={{
              ...
              alignSelf:'flex-end'}} onPress={()=>{this.setState({isOpen:true})}}>
                <Text style={styles.buttonFont} allowFontScaling={false}>Submit</Text>
            </TouchableOpacity>
          </View>
          <Modal style={styles.modal} position={"bottom"} backdropOpacity={0.6}  isOpen={this.state.isOpen} backdropPressToClose={false} swipeToClose={false}>
...
AppRegistry.registerComponent('addCardEN', () => addCardEN);
