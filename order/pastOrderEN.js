...
const orderInfo = {
    statue:"Order Delivered",
    time:"Feb 25, 2017, 8:36 PM",
    orderID:"66A34",
    food:[
      {
        name:"Corn Cheese",
      ...
      {
        name:"Green Onion Chicken Chicken",
        quantity: 1,
      }
    ],
    total:"$42.28",
        ...
        <View style={styles.container}>
          <View style={styles.itemContainer}>
              ...
              <View style={styles.info}>
                  ...
                  <Text style={styles.infoText} allowFontScaling={false}>Order #{orderInfo.orderID}</Text>
              </View>
              <View style={styles.orderList}>
                {this._renderFoodList()}
              </View>
              <View style={styles.orderTotal}>
                <Text style={{fontSize:18,marginLeft:40,fontWeight:'bold'}} allowFontScaling={false}>Total: {orderInfo.total}</Text>
              </View>
              <View style={styles.buttonContainer}>
                  <View style={[styles.ButtonStyle,{borderRightWidth:0.5}]}>
                      <TouchableOpacity style={{flex:1,
                                                ...
                                                alignItems:'center'}}>
                        <Text style={{fontSize:12,color:'#666666',fontWeight:'bold'}} allowFontScaling={false}>VIEW RECEIPT</Text>
                      </TouchableOpacity>
                  </View>
                  <View style={[styles.ButtonStyle,{borderRightWidth:0.5}]}>
                      <TouchableOpacity style={{flex:1,
                                                justifyContent:'center',
                                                alignItems:'center'}}>
                        <Text style={{fontSize:12,color:'#666666',fontWeight:'bold'}} allowFontScaling={false}>GET HELP</Text>
                      </TouchableOpacity>
                  </View>
              </View>
          </View>
