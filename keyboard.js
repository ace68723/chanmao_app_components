...
export default class CMKeyBoard extends Component {
    ...
    componentDidMount(){
      test=this.state.bounceValueMarker.interpolate({
          inputRange: [0, 1],
          outputRange: ['rgba(25,25,25,1)', 'rgba(25,25,25,0)']
        });
    ...
    _renderNumMarker()
    {
       if (this.state.isOpen){
         console.log(this.state.bounceValueMarker);
              ...
              <TouchableWithoutFeedback onPress={()=>{this._showKeyboard("cardNum")}} >
                  <View style={styles.input}>
                            ...
                            <View style={{height:25,width:36,marginTop:30}}>
                              <Image source={require('./icon/icon_card.png')} style={{height:25,width:36,opacity:0.5}}/>
                            </View>
